...
server <- function(input, output, session) {
  ...
  #   ####################### 2nd PLOT FROM TBX5_ANALYSIS_I ###################### <- WORKS
  ...
  #   ######################## 4th PLOT PWM SEQUENCE LOGO ######################## <- WORKS
  ...
  #   })
    ...
    # PERFORM DE-NOVO MOTIF IDENTIFICATION USING rGADEM!
    # PAKLAUSTI!
    ...
    # system(paste0("findMotifsGenome.pl ~/Desktop/IV_course/II_semester/TF_analysis/Analyses/Tbx5_analysis_I/Inputs/BED/", bigbed_files[3], " mm10 ~/Desktop/IV_course/II_semester/TF_analysis/results/ -size 200 -mask"), intern = FALSE)
      ...
      homer_motifs <- read.table(paste0("/home/daniele/Desktop/IV_course/",
      "II_semester/TF_analysis/results/knownResults.txt"), sep = "\t",
      header = FALSE, skip = 1)
