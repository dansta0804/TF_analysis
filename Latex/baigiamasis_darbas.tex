...
regionus - pakeista ChIP-Altas duomenų baze. Pastaroji duomenų bazė turi
didesnį kiekį ChIP sekoskaitos duomenų, kurie gali būti panaudoti atliekant
tyrimus, nei GTRD duomenų bazėje, kuriai būdingas mažesnis duomenų rinkinys.

Metodo testavimui naudoti 7 skirtingi naminių pelių (lot. \emph{Mus musculus})
bei 6 skirtingi žmogaus (lot. \emph{Homo sapiens}) mėginiai, išgauti iš
...
\begin{itemize}
    \item \textbf{mESC} - naminių pelių embrioninės kamieninės ląstelės
          (angl. \emph{Mouse Embryonic Stem Cells});
    \item \textbf{C57BL/6 x DBA} - 
\end{itemize}
...
\begin{table}[htb]
    ...
    \hline
    \thead{Nervinės\\progenitorinės} & - & Laukinis tipas &
    \thead{anti-SOX2} &
    \thead{\href{https://chip-atlas.org/view?id=SRX5716451}{SRX5716451}}\\ 
    \hline
    \thead{Nervinės\\progenitorinės} & - & K755R/+ &
    \thead{anti-SOX2} &
...
\begin{itemize}
    \item \textbf{hESC} - žmogaus embrioninės kamieninės ląstelės
          (angl. \emph{Human Embryonic Stem Cells});
    \item \textbf{K755R/+} - 
\end{itemize}
